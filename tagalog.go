...
var Tagalog TagalogListing = []*TagalogEntry{
	...
	// T_Blk_Para, "", "", "", false, false}, // 3.3.15
	{CT_Blk_CdBlk, "", "", "", false, false},
	{CT_Blk_Quote, "", "", "", false, false},
	// _Blk_OList, "", "", "", false, false}, // 3.3.14
	// _Blk_UList, "", "", "", false, false}, // 3.3.19
	{CT_Blk_Hedr, "", "", "", false, false},
	{CT_Blk_HRule, "", "", "", false, false},
	{CT_Blk_Table, "", "", "", false, false},
	// _Blk_Figure, "", "", "", false, false}, // 3.3.9
	// CTT_Blk_Div, "", "", "", false, false}, // 3.3.4

	{CT_Inl_Text, "", "", "", false, false},
	// T_Inl_Emph, "", "", "", false, false}, // 3.5.1
	// _Inl_Undln, "", "", "", false, false}, // 3.4.5
	// _Inl_Strng, "", "", "", false, false}, // 3.5.2
	{CT_Inl_Strike, "", "", "", false, false},
	// _Inl_Super, "", "", "", false, false}, // 3.4.4
	// CT_Inl_Sub, "", "", "", false, false}, // 3.4.3
	{CT_Inl_Quote, "", "", "", false, false},
	{CT_Inl_Citatn, "", "", "", false, false},
	{CT_Inl_Code, "", "", "", false, false},
	{CT_Inl_LnBrk, "", "", "", false, false},
	// _Inl_Link, "", "", "", false, false}, // 3.3.20
	// Inl_Image, "", "", "", false, false}, // 3.3.11
	// _Inl_Span, "", "", "", false, false}, // 3.3.16
	...
	{CT_TBS, "shortdesc", "", "", true, false},
	// 3.2.1 Body
	{CT_TBS, "body", "body", "", false, false},
	// ===================
	// 3.3 Body components
	// ===================
	...
	{CT_TBS, "desc", "@title", "?", false, true},
	// 3.3.4 Division
	{CT_Blk_Div, "", "", "", false, false},
	// 3.3.5 Definition list (the outermost wrapper for the definition list)
	{CT_TBS, "dl", "dl", "?", true, false},
	// 3.3.6 Definition list entry (wraps <dt> & <dd>, in XDITA only)
	{CT_TBS, "dlentry", "?", "?", true, false},
	// 3.3.7 Definition term (a definition's LH side)
	{CT_TBS, "dt", "dt", "", false, true},
	// 3.3.8 Example
	{CT_TBS, "example", "<div data-class=\"example\">",
		"h{.example}", true, false},
	// 3.3.9 Figure
	{CT_Blk_Figure, "fig", "figure", "", true, false},
	// 3.3.10 Footnote
	{CT_TBS, "fn", "<span data-class=\"fn\">", "?", true, false},
	// 3.3.11 Image
	{CT_Inl_Image, "image", "img", "?", false, true},
	// 3.3.12 List item
	{CT_TBS, "li", "li", "?", true, false},
	// 3.3.13 Note
	{CT_TBS, "note", "<div data-class=\"note\">", "", true, false},
	// 3.3.14 Ordered list
	{CT_Blk_OList, "ol", "ol", "?", true, false},
	// 3.3.15
	{CT_Blk_Para, "p", "p", "?", true, false},
	// 3.3.16 Paragraph
	...
	{CT_Inl_Span, "ph", "span", "", false, true},
	// 3.3.17 Preformatted text
	{CT_TBS, "pre", "pre", "?", true, false},
	// 3.3.18 Section
	...
	{CT_TBS, "section", "section", "?", true, false},
	// 3.3.19 Unordered list
	{CT_Blk_UList, "ul", "ul", "", true, false},
	...
	{CT_Inl_Link, "xref", "a@href", "", false, true},
	// ===========================
	...
	{CT_Inl_Italic, "i", "i", "?", false, true},
	// 3.4.3 Subscript
	{CT_Inl_Sub, "sub", "sub", "", false, true},
	// 3.4.4 Superscript
	{CT_Inl_Super, "sup", "sup", "", false, true},
	// 3.4.5 Underline
	{CT_Inl_Undln, "u", "u", "", false, true},
	// =======================
	...
	{CT_Inl_Emph, "em", "em", "*,_", false, true},
	// 3.5.2 Strong text
	// This of greater importance than the surrounding text.
	{CT_Inl_Strng, "strong", "strong", "**,__", false, true},
	// ==================
	// 3.6 Map components
	// ==================
	...
	{CT_TBS, "keydef", "<div data-class=\"keydef\">", "(hdita)", false, true}, // OR BLK
	// 3.6.2 Key text
	...
	{CT_TBS, "keytext", "<div data-class=\"keytext\">", "(hdita)", false, true},
	// 3.6.3 Map
	...
	{CT_TBS, "topicref", "li>a@href", "li>[link](/URI \"title\")", false, true},
	// =======================
	...
	{CT_TBS, "data", "head>meta", "(yaml-header)", false, false},
	// 3.7.2 Prolog
	// This has metadata about the topic; e.g. author information or subject category.
	{CT_TBS, "prolog", "head>meta", "yaml-header)", false, false},
	// =========================
	...
	{CT_TBS, "audio", "audio", "(hdita)", false, false},
	// 3.8.2 Fallback
	// This is content to present when multimedia objects cannot be rendered.
	{CT_TBS, "fallback", "?", "(hdita)", false, false},
	// 3.8.3 Source
	...
	{CT_TBS, "audio|video>media-source", "audio|video>source", "(hdita)", false, false},
}
